...
```python
options['result_function'](/ground-control/robot-integration/connector-framework/usage/
...
async def _inorbit_robot_command_handler(
    ...
    if command_name == "start_mission":
        try:
            ...
            options["result_function"](/ground-control/robot-integration/connector-framework/usage/CommandResultCode.SUCCESS)
